...
import numpy as np
from google.cloud.aiplatform_v1 import (IndexDatapoint, IndexServiceClient,
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        sys.exit("""Usage: python upsert_image.py <image_path>
          image_path: The path to the image to upsert""")
